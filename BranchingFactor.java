 ...
 * described in Russell and Norvig (page 103 of 3rd ed. or page 106 of 2nd ed.).
 */
public class BranchingFactor {
	 ...
	 * <tt>num_generated</tt> nodes were generated, and a solution at the given
	 * <tt>depth</tt> was discovered. Note that <tt>depth</tt> must be nonnegative,
	 * and <tt>num_generated</tt> must be at least <tt>depth</tt> plus one
	 * (otherwise an <tt>IllegalArgumentException</tt> will be thrown).
	 */
	public static double compute(int num_generated, int depth) {
